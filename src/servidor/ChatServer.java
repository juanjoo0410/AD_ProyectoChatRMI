...
public class ChatServer extends javax.swing.JFrame {
    ...
    private void initServer(){
        try {
            ...
            txtLog.append("Error: Fallo al crear el registro RMI o al exportar el objeto remoto.");
        } catch (MalformedURLException e) {
            txtLog.append("Error: URL mal formada al registrar el objeto remoto.");
        } catch (Exception e) {
            txtLog.append("Error inesperado al iniciar el servidor.");
        }
    }
    
    public static void updateUserList(List<Cliente> users) {
        SwingUtilities.invokeLater(() -> {
            txtUsers.setText("");
            for (Cliente user : users) {
                try {
                    txtUsers.append(user.getUsername() + "\n");
